import type { IEventCreatedPayload } from '@volontariapp/messaging';
...
export function makeTestEvent(id: string): StreamEvent<IEventCreatedPayload> {
  return {
    id,
    type: EventMessagingType.EVENT_CREATED,
