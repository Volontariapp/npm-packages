...
export interface EventQueryServiceClient {
  ...
  getEventsByIds(request: GetEventsByIdsQuery): Observable<GetEventsByIdsResponse>;
...
export interface EventQueryServiceController {
  ...
  getEventsByIds(
    request: GetEventsByIdsQuery,
  ): Promise<GetEventsByIdsResponse> | Observable<GetEventsByIdsResponse> | GetEventsByIdsResponse;
