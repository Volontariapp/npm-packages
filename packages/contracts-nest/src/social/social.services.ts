...
export interface RelationshipQueryServiceClient {
  ...
  getIsFollowing(request: GetIsFollowingQuery): Observable<GetIsFollowingResponse>;

  adminGetIsFollowing(request: AdminGetIsFollowingQuery): Observable<AdminGetIsFollowingResponse>;
}
...
export interface RelationshipQueryServiceController {
  ...
  getIsFollowing(
    request: GetIsFollowingQuery,
  ): Promise<GetIsFollowingResponse> | Observable<GetIsFollowingResponse> | GetIsFollowingResponse;

  adminGetIsFollowing(
    request: AdminGetIsFollowingQuery,
  ): Promise<AdminGetIsFollowingResponse> | Observable<AdminGetIsFollowingResponse> | AdminGetIsFollowingResponse;
}
...
export interface ParticipationQueryServiceClient {
  ...
  getRecommendedEventIds(request: GetRecommendedEventIdsQuery): Observable<GetRecommendedEventIdsResponse>;
}
...
export interface ParticipationQueryServiceController {
  ...
  getRecommendedEventIds(
    request: GetRecommendedEventIdsQuery,
  ):
    | Promise<GetRecommendedEventIdsResponse>
    | Observable<GetRecommendedEventIdsResponse>
    | GetRecommendedEventIdsResponse;
}
